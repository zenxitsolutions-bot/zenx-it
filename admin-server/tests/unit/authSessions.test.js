...
import * as staff from '../../src/controllers/auth.controller.js';
import * as customer from '../../src/controllers/customerAuth.controller.js';
import { authenticateStaff, authenticateCustomer } from '../../src/middleware/authenticate.js';
const realms = [
  { kind: 'staff', cookie: 'zenxadmin_refresh', ...staff, authenticate: authenticateStaff,
    signAccess: jwt.signStaffAccessToken, signRefresh: jwt.signStaffRefreshToken,
    verifyAccess: jwt.verifyStaffAccessToken, verifyRefresh: jwt.verifyStaffRefreshToken },
  { kind: 'customer', cookie: 'zenxcustomer_refresh', ...customer, authenticate: authenticateCustomer,
    signAccess: (user, sid) => jwt.signCustomerAccessToken(user, user.companyId, sid),
    signRefresh: (user, sid) => jwt.signCustomerRefreshToken(user, user.companyId, sid),
    verifyAccess: jwt.verifyCustomerAccessToken, verifyRefresh: jwt.verifyCustomerRefreshToken },
];
