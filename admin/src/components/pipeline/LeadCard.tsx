  ...
  return (
    ...
    >
      <div className="mb-2 flex items-start justify-between gap-2">
        <p className="text-sm font-semibold leading-tight text-offwhite">{enquiry.company_name || enquiry.contact_name}</p>
      ...
      <div className="mt-3 flex items-center justify-between border-t border-border pt-2.5 text-[10px] text-dim">
        <span className="rounded-full bg-ink px-2 py-1">{enquiry.service || "Not provided"}</span>
