...
export function JoinMeetingButton({ call, className = '' }) {
  ...
  return (
    <a
      ...
      className={`inline-flex h-10 items-center gap-2 rounded-lg bg-coral px-5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-brand-strong ${className}`}
    >
