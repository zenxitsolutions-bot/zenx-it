...
import { MEAL_TIME_OPTIONS, hasSwapReplacement, normalizeMealTime } from '@/lib/planBuilder';
...
export function ScheduleRow({
  ...
  const swappedRecipe = hasSwapReplacement(meal);
  const recipeReadOnly = readOnly && !allowRecipeSwap;
  const canNotify = !recipeReadOnly && meal.swapRequested;
  ...
  return (
    ...
    >
      ...
      {meal.swapRequested && !recipeReadOnly && onNotifySwap && (
