...
export function useAvailableSlots({ dietitianId, date, excludeCallId }) {
  return useQuery({
    queryKey: ['calls', 'available-slots', dietitianId, date, excludeCallId ?? null],
    queryFn: () => getAvailableSlotsRequest({ date, dietitian: dietitianId, excludeCallId }),
