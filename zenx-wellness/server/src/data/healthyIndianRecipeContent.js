...
// Only exact recipe matches are allowed. Pending recipes use their emoji.
export const CATALOG_IMAGES = GENERATED_RECIPE_IMAGES;
export function catalogImageFor(title) {
  return GENERATED_RECIPE_IMAGES[title] || null;
}
